...
public class MainProxiBanque {
	...
	public static void main(String[] args) {
		...
		conseiller.creerClient(
				new Client("Burel", "Seb", "643 route de Layrac", 31200, "Toulouse", "0611167004", cc, ce));
		...
		while (y) {
			...
			case 1:
				...
				System.out.println(
						"Choix de la carte bancaire de la personne à ajouter : tapez 1 pour Visa Electron ou tapez 2 pour Visa Premier");
				boolean x = true;
				while (x) {
					...
					case 1:
						...
						System.out.println("Le compte courant a bien ete cree : Numero = " + numeroCC + ", solde = "
								+ soldeCC + ", annee de creation = " + anneeCC + ", carte bancaire choisie = " + cb);
						System.out.println("Le compte epargne a bien ete cree : Numero = " + numeroCE + ", solde = "
								+ soldeCE + ", annee de creation = " + anneeCE);
			...
			case 5:
				System.out.println(
						"Voulez vous effectuer un virement depuis le Compte Courant vers le Compte Epargne (tapez 1) ou depuis le Compte Epargne vers le compte Courant (tapez 2) ?");
				boolean x2 = true;
				while (x2) {
			...
			// Choix 6
			case 6:
				System.out.println("Simuler un credit");
				System.out.println("Voulez vous simuler un credit conso (tapez 1) ou un credit immo (tapez 2) ?");
				boolean x3 = true;
				while (x3) {
					int choix4 = clavier.nextInt();
					switch (choix4) {
					case 1:
						System.out.println("Credit Consommation choisi");
						System.out.println("Nom de la personne détentrice des comptes : ");
						String nom6 = clavier.next();
						System.out.println("Prenom de la personne détentrice des comptes : ");
						String prenom6 = clavier.next();
						Client client6 = conseiller.lireClient(nom6, prenom6);

						System.out.println("Entrer la somme à emprunter (inférieure à 5 000€) : ");
						float emprunt = clavier.nextFloat();
						System.out.println("Choisir la duree du credit: ");
						int nbMois = clavier.nextInt();
						conseiller.simulerCreditConso(client6, emprunt, nbMois);
						//System.out.println("vos mensualité seront de :" + mensualites);
						x3 = false;

						break;

					case 2:
						System.out.println("Credit Immo choisi");
						System.out.println("Nom de la personne détentrice des comptes : ");
						String nom7 = clavier.next();
						System.out.println("Prenom de la personne détentrice des comptes : ");
						String prenom7 = clavier.next();
						Client client7 = conseiller.lireClient(nom7, prenom7);

						System.out.println("Entrer la somme à emprunter (Supérieure à 50 000€) : ");
						float emprunt1 = clavier.nextFloat();
						System.out.println("Choisir la duree du credit: ");
						int nbMois1 = clavier.nextInt();
						conseiller.simulerCreditImmo(client7, emprunt1, nbMois1);
						x3 = false;
						break;
					default:
						System.out.println("Choix invalide, tapez 1 ou 2");
